        ...
        for (const property in obj) {
            for (var key in obj[property]) {
                if (obj[property].hasOwnProperty(key)) {
                    ...
                    } else if (obj[property][key].toLowerCase() === 'true') {
                        obj[property][key] = true;
                    } else if (obj[property][key].toLowerCase() === 'false') {
                        obj[property][key] = false;
                    } else if (obj[property][key].toLowerCase() === 'null') {
